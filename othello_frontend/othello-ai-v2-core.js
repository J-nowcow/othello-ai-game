...
class OthelloAI_v2 {
    constructor(difficulty = 'expert') {
        ...
        this.wpcWeights = [
            [100, -20, 10, 5, 5, 10, -20, 100],     // 구석: 100, 가장자리: -20
            [-20, -80, -2, -2, -2, -2, -80, -20],   // B2, B7: -80 (매우 위험)
            [10, -2, 1, 1, 1, 1, -2, 10],            // 중간 가장자리: 10
            [5, -2, 1, 1, 1, 1, -2, 5],              // 중앙: 5
            [5, -2, 1, 1, 1, 1, -2, 5],              // 중앙: 5
            [10, -2, 1, 1, 1, 1, -2, 10],            // 중간 가장자리: 10
            [-20, -80, -2, -2, -2, -2, -80, -20],   // G2, G7: -80 (매우 위험)
            [100, -20, 10, 5, 5, 10, -20, 100]      // 구석: 100, 가장자리: -20
        ];
